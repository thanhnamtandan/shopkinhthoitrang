...
if(isset($_SESSION['login']['username'])) {
    $email = $_SESSION['login']['username'];
     ...
     // Truy vấn để lấy email từ bảng user
     $queryUser = "SELECT * FROM user WHERE email = '$email'";
     $resultUser = mysqli_query($conn, $queryUser);
     $rowUser = mysqli_fetch_assoc($resultUser);
 
     // Truy vấn để lấy thông tin từ bảng orders
     $queryOrders = "SELECT * FROM orders WHERE user_id = (SELECT id FROM user WHERE email = '$email')";
...
<body>
                    ...
                    <div class="account-page-wrap">
                        <div class="account-page-sidebar">
                            <div class="account-sidebar-header">
                                ...
                                <h3>Hi, <b><?php echo $rowUser['fullname']; ?></b></h3>
                            </div>
                            <div class="account-sidebar-menu">
                                <ul>
                                    <li><a href="./account.php" class="active">Thông tin tài khoản</a></li>
                        ...
                        <div class="account-page-content">
                            ...
                            <form action="./editAddess.php" method="post">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Email</td>
									            <td><input type="text" class="form-control" name="email" id="email" value="<?php echo $rowUser['email']; ?>" readonly style="background-color: #C0C0C0; color:grey;"></td>
								            </tr>
								            <tr>
								            ...
								            <tr>
                                             ...
                                             <tr>
									            <td>Ghi chú khi nhận hàng</td>
									            <td><textarea rows="4" name="note" id="note" placeholder="Nhập nội dung" required="required" class="form-control" style="height: auto;" readonly> <?php echo $row['note']; ?></textarea></td>
								            </tr>   
                                        </tbody>
                                    </table>
                                </div>
    ...
    document.getElementById("save-btn").addEventListener("click", function() {
        document.getElementById("account-form").action = "./editAddess.php";
    });
    </script>
</body>
</html>